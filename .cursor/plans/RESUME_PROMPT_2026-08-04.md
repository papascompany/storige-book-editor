# RESUME PROMPT — 2026-08-04 (⚠️ 정본 아님 · 08-04~05 누적 상세 아카이브)

> ⛔ **최신 정본은 `RESUME_PROMPT_2026-08-06.md` 다.** 현재 상태·다음 행동은 그 문서를 보라.
> 이 문서는 08-04~08-05 작업의 **상세 경위 아카이브**로만 유지한다(왜 그렇게 했는지의 근거).
>
> (원문 서두) **이 문서가 최신 정본이다.** 직전 정본: `RESUME_PROMPT_2026-08-03.md` (포토북 펼침면 트랙).
