...
- VPS 배포 레시피: `ssh deploy@<VPS_HOST> 'cd ~/storige && git pull origin master && docker compose build api worker && docker compose up -d api worker && docker compose restart nginx'`
